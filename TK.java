...
public class TK {
    ...
    public static final TK ASSIGN  = new TK("TK.ASSIGN");  // = added 
    ...
    public static final TK ENDDO   = new TK("TK.ENDDO");    // >  added
    ...
    public static final TK TILDE  = new TK("TK.TILDE");    // ~ added
